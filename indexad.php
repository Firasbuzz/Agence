      ...
      <div class="container">
        <nav id="menuzord-right" class="menuzord default">
          ...
          <ul class="menuzord-menu">
            <li class="active"><a href="indexad.php">Home   <span class="indicator"></span></a>
            ...
            <li><a href="#">Affichage</a>
              <ul class="dropdown">
                ...
                <li><a href="afficherrev.php">Afficher Reservation</a></li>
              </ul>
            <li><a href="modifier.php">Modifier</a>
            <li><a href="supprimer.php">Supprimer</a>
