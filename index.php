      ...
      <div class="container">
        <nav id="menuzord-right" class="menuzord default">
          ...
          <ul class="menuzord-menu">
            <li class="active"><a href="/agence/sign.php">Home   <span class="indicator"></span></a>
            
              
            
            </li>
            <li><a href="sign.php">Signup</a>
            </li>

            <li><a href="login.php">Login admin</a>
            <li><a href="logincli.php">Login utilisateur</a>
            <li><a href="#">Info</a>
              <ul class="dropdown">
